...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    ...
    'es': {
      ...
      'total': 'TOTAL',
      'numberOfPlayers': 'Número de equipo',
      ...
      'players': 'equipo',
      'addPlayer': 'Agregar equipo',
      'playerName': 'Nombre del equipo',
      'indexedPlayerName': 'Nombre del equipo @index',
      'playerDefaultName': 'Equipo @index',
      'cancel': 'Cancelar',
      'add': 'Agregar',
      'language': 'Idioma',
      'whatIsDomino': '¿Qué es Dominó?',
      'whatIsDominoDesc':
          'El dominó es un juego clásico de fichas donde los equipos emparejan fichas con el mismo número de puntos. Generalmente se juega en equipos, y los equipos anotan puntos jugando fichas que coincidan con los extremos abiertos del juego.',
